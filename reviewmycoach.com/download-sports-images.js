...
async function downloadAllImages() {
    console.log('🚀 Starting sports images download...\n');
    ...
    try {
        ...
        console.log(`\n🎉 Successfully downloaded all ${Object.keys(sportsImages).length} sports images!`);
        console.log(`📁 Images saved to: ${sportsDir}`);
    } catch (error) {
        console.log('\n⚠️  Some downloads failed, but continuing...');
    }
}
