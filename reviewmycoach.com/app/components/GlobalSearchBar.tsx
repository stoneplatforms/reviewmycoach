  ...
  return (
    <div ref={searchRef} className={`relative ${className}`}>
      ...
      {isOpen && showSuggestions && (searchTerm.length >= 2 || suggestions.length > 0) && (
        <div className="absolute z-[102] w-full mt-1 border border-gray-800 rounded-sm shadow-xl bg-gray-900 max-h-64 overflow-y-auto">
              ...
              {suggestions.map((suggestion, index) => (
                <button
                  ...
                  className={`w-full px-4 py-2.5 text-left hover:bg-gray-800 flex items-center space-x-3 transition-colors ${
                    index === selectedIndex ? 'bg-gray-800 border-l-2 border-red-500' : ''
                  }`}
                >
              ...
              {searchTerm.trim() && (
                <>
                  ...
                  >
                    ...
                    <span className="text-sm font-medium">Search for &quot;{searchTerm}&quot;</span>
                  </button>
                </>
              )}
            </>
